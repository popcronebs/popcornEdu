...
@section('layout_coutent')
    ...
    <div class="col-12 pe-3 ps-3 position-relative">
        ...
        <table class="w-100 table-serach-style table-border-xless table-h-92 div-shadow-style rounded-3">
            ...
            <thead></thead>
            <tbody>
              <tr class="text-start  border-gray-bottom">
                <td class="text-start px-4 scale-text-gray_06 py-20">
                  <div class="d-inline-block select-wrap w-100 d-flex position-relative h-32 ">
                    <select id="systemteam_sel_sido" onchange="systemteamSelectGu(this);"
                    class="border-none lg-select rounded-0 text-sb-20px scale-text-gray_05 p-0 w-100">
                ...
                <td class="text-start px-4 py-20">
                  <div class="d-inline-block select-wrap py-0 w-100 d-flex position-relative h-32">
                    <select id="systemteam_sel_gu" onchange="systemteamSelectDong(this)"
                    class="border-none lg-select rounded-0 text-sb-20px scale-text-gray_05 p-0 w-100">
                      <option value="">담당구역(1)을 선택해주세요.</option>
                    </select>
              ...
              <tr class="text-start">
                <td colspan="3" class="text-start px-4 scale-text-gray_06 py-4" style="height: 72px">
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="col">
                        {{-- 담당구역 소분류 선택 --}}
                        <ul id="systemteam_div_sel_dong" class="d-flex flex-wrap col">
                            <li class="copy_btn_sel_dong" onclick="systemteamRemoveBtn(this)" hidden>
                    ...
                    <div class="col">
                        {{-- 선택된 지역 확인 --}}
                        <div id="systemteam_div_dong" class="d-flex gap-3 flex-wrap">
                            <label class="checkbox row mx-0 align-items-center col-auto" hidden>
                                <input type="checkbox" class="" id="systemteam_btncheck1" autocomplete="off"
                                onchange="systemteamClickDong(this);">
                                <span class="px-0 col-auto"></span>
                                <p class="text-m-20px ms-1 col-auto px-0">전체</p>
                              </label>
                        </div>
                        
                        <label id="systemteam_div_dong_clone" class="div_dong_clone checkbox row mx-0 px-0 align-items-center" hidden>
                          <input type="checkbox"  class="copy_inp_dong1" onchange="systemteamClickDong(this);">
        ...
        {{-- 입력 검색 기능 --}}
        <div class="d-flex justify-content-end align-items-end mt-120 mb-32">
            ...
            <table class="table-style w-100">
                <thead>
                    <tr class="text-sb-20px modal-shadow-style rounded">
                        ...
                        onclick="event.stopPropagation();this.querySelector('span').click()">
