      ...
      <div class="login-wrap w-100">
        ...
        <form action="" method="post" class="" onsubmit="">
          ...
          <input type="hidden" id="main_code" name="main_code" value="elementary">
            <div>
                <p class="text-b-20px mb-12 mt-4">이름</p>
                <div class="row w-100">
                    <div class="col-12 p-0">
                        <label class="label-input-wrap w-100">
                            <input type="text" id="userName" name="userName" class="smart-ht-search border-gray rounded text-m-20px w-100 h-68" placeholder="이름을 입력해주세요." autocomplete="userName" required>
                        </label>
                    </div>
                </div>
            </div>
          <div>
            ...
            <div class="row w-100">
              <div class="col-12 p-0">
                <label class="label-input-wrap w-100">
                  <input type="text" id="phoneNumber" name="phoneNumber" class="smart-ht-search border-gray rounded text-m-20px w-100 h-68" placeholder="전화번호를 입력해주세요." autocomplete="phoneNumber" required>
                </label>
              </div>
            </div>
            ...
            <div class="row w-100">
              ...
              <div class="col-3 ps-2 pe-0">
                <button onclick="sendBtnAuthNumber()"
                    type="button" id="usernameCheck" name="usernameCheck" class="btn-lg-primary text-b-16px rounded scale-text-white scale-bg-black scale-bg-gray_06-hover w-100 text-center justify-content-center h-68">인증번호전송</button>
              </div>
            </div>
    ...
    <div class="modal-dialog modal-shadow-style rounded">
      <div class="modal-content border-none rounded p-3">
        ...
        <div class="modal-body">
          <p class="text-sb-20px mb-3">회원님의 아이디 정보입니다.</p>
          <div class="col-12 px-0 mb-3">
            <label class="label-input-wrap w-100">
              <input type="text" class="smart-ht-search border-gray rounded text-m-20px w-100" placeholder="제목을 입력해주세요." id="userIdInfo" name="userIdInfo" value="test123" readonly>
            </label>
          </div>
        </div>
        <div class="modal-footer border-top-0">
          <a href="/login" class="btn-lg-primary text-b-24px rounded scale-text-white w-100 justify-content-center search-btn">로그인 페이지로</a>
        </div>
      </div>
    </div>
  </div>
        ...
        function checkAuthNumber() {
            ...
            queryFetch(page, parameter, function(result){
              if(result.resultCode === 'success'){
                    document.getElementById("userIdInfo").value = result.userId;
