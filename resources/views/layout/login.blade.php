...
<head>
    ...
    <link href="{{ asset('css/admin_style.css?29') }}" rel="stylesheet">
    ...
    <script src="{{ asset('js/admin_script.js?20') }}"></script>
    <title>팝콘 로그인</title>
</head>
<body>
    <main class="zoom_sm">
        <div class="main-wrap all-center" style="height:100vh;max-width:448px">
          <div class="login-wrap">
            <div class="d-flex justify-content-center">
              <span class="ht-make-title on text-r-20px py-1 px-3 ms-1 mb-4">로그인</span>
            </div>
              ...
              <div class="row w-100 mx-0">
                <div class="col-12 p-0 mb-12px">
                  <label class="label-input-wrap w-100">
                    ...
                    id="id" name="id" placeholder="아이디" value="{{$_COOKIE['save_usr_id']??''}}">
                  </label>
                </div>
              <div class="col-12 p-0 pt-2">
                ...
                <div class="row w-100 p-0 mb-4 mt-3 mx-0">
                  <div class="col-12 p-0">
                    <button id="loginButton" type="submit" class="btn-lg-primary text-b-24px rounded scale-text-white w-100 text-center justify-content-center">로그인</button>
                  </div>
                </div>
            </form>
                <div class="d-flex justify-content-center gap-2">
                  <a href="/user/id/find" class="scale-text-gray_05 text-m-18px">아이디 찾기</a>
                  <div class="all-center px-1"><div class=" h-75 scale-bg-gray_05" style="width:2px"></div></div>
                  <a href="/user/pw/find" class="scale-text-gray_05 text-m-18px">비밀번호 찾기</a>
                </div>
