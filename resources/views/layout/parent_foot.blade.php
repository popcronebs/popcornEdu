...
<div id="system_alert" hidden>
    <div class="modal modal-sheet position-fixed d-block top-50 start-50 translate-middle" tabindex="-1" role="dialog"
        style="width:25%;height:auto;z-index: 9999;">
...
<div class="row foot_top border-bottom">
    <div class="col row align-items-center">
        <a class="col-auto link-secondary text-decoration-none cursor-pointer cfs-7 p-0">회사소개</a>
        <a class="col-auto link-secondary text-decoration-none cursor-pointer cfs-7 ms-5 px-0">선생님 지원</a>
        <a class="col-auto link-secondary text-decoration-none cursor-pointer cfs-7 ms-5 px-0">제휴문의</a>
