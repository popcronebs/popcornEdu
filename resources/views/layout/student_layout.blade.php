...
<div class="content row m-0 p-0 h-100">
    <header class="p-0">
        ...
        <nav id="layout_main_top2" class="row border align-items-center main_top_p mx-0">
            {{-- 메뉴 쪽 로고 --}}
            <a class="col-auto" href="/student">
                <img src="{{ asset('/images/popcorn_logo.svg') }}" alt="">
            </a>
            {{-- <span class="fs-6 col-auto p-0" style="color:#ffb357">For student</span> --}}
                    ...
                    <ul class="menu-items" data-parent-layout-profile>
                        ...
                        <li class="menu-item mt-3">
                            <div class="h-center gap-2">
                                ...
                                <div class="col text-sb-18px cursor-pointer" data-layout-menu="/student/notice?nc=notice" onclick="parentLayoutPageMove(this);">공지사항</div>
                        ...
                        <li class="menu-item mt-3">
                            <div class="h-center gap-2">
                                ...
                                <div class="col text-sb-18px cursor-pointer" data-layout-menu="/student/notice?nc=faq" onclick="parentLayoutPageMove(this)">자주묻는질문</div>
                                <div class="col-auto" hidden>
                                    <img src="{{ asset('images/dropdown_arrow_down.svg') }}" style="filter: grayscale(1);" width="24px">
                                </div>
                            </div>
                        ...
                        <li class="menu-item mt-3" hidden>
                            <div class="h-center gap-2">
                                ...
                                <div class="col text-sb-18px cursor-pointer" data-layout-menu="/teacher/messenger" onclick="parentLayoutPageMove(this)">원격지원 연결</div>
                                <div class="col-auto" hidden>
                                    <img src="{{ asset('images/dropdown_arrow_down.svg') }}" style="filter: grayscale(1);" width="24px">
                                </div>
                            </div>
...
<script>
    ...
    // 학생 마지막 접속시간 업데이트.
    function studentLastDataUpdate() {
        const page = "/student/last/connect/time/update"
        const paramter = {};
        queryFetch(page, paramter, function(result) {});
    }
    document.addEventListener('DOMContentLoaded', function() {
        studentLastDataUpdate();
        // 5분마다 실행
