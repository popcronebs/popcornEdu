...
<body>
  <main>
    <div class="swiper" style="background-color: #ffb600;">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
            <img src="{{ asset('/images/marketing_img/메세지_영어_1.jpg') }}" alt="팝콘 영어 소개 이미지 1">
        </div>
        <div class="swiper-slide">
            <img src="{{ asset('/images/marketing_img/메세지_영어_2.jpg') }}" alt="팝콘 영어 소개 이미지 2">
        </div>
        <div class="swiper-slide">
            <img src="{{ asset('/images/marketing_img/메세지_영어_3.jpg') }}" alt="팝콘 영어 소개 이미지 3">
        </div>
      </div>
