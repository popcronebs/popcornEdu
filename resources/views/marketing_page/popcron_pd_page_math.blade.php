...
<body>
  <main>
    <div class="swiper" style="background-color: #51cdcf;">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
            <img src="{{ asset('/images/marketing_img/메세지_수학_1.jpg') }}" alt="팝콘 수학 소개 이미지 1">
        </div>
        <div class="swiper-slide">
            <img src="{{ asset('/images/marketing_img/메세지_수학_2.jpg') }}" alt="팝콘 수학 소개 이미지 2">
        </div>
        <div class="swiper-slide">
            <img src="{{ asset('/images/marketing_img/메세지_수학_3.jpg') }}" alt="팝콘 수학 소개 이미지 3">
        </div>
      </div>
