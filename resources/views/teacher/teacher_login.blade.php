        ...
        <div class="main-wrap all-center" style="height:100vh;max-width:448px">
          <div class="login-wrap">
            <div class="d-flex justify-content-center">
              <span class="ht-make-title on text-r-20px py-1 px-3 ms-1 mb-4">선생님 로그인</span>
            </div>
            ...
            <form class="form-horizontal" action="/teacher/login" method="post" onsubmit="return validateForm()">
                @csrf
            <div class="py-52px">
              <div class="row w-100 mx-0">
                <div class="col-12 p-0 mb-12px">
                  <label class="label-input-wrap w-100">
                    <input type="text" class="smart-ht-search border-gray rounded text-m-20px w-100" id="id" name="id" placeholder="아이디">
                  </label>
                </div>
                <div class="col-12 p-0 pt-2">
                  <label class="label-input-wrap w-100">
                    <input type="password" class="smart-ht-search border-gray rounded text-m-20px w-100" id="password" name="password" placeholder="비밀번호">
                  </label>
                </div>
